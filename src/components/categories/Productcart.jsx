      ...
      {data.length >= 1 ? (
        <>
          <div className="pt-5 z-[99999]">
            <div className={`overflow-y-auto transition-all duration-300  border-b ${showprice && !showremove ? 'lg:max-h-[40vh] max-h-[38vh] ' : showremove && showprice  ? '!max-h-[35vh] lg:!max-h-[35vh]' : 'md:max-h-[58vh] max-h-[54vh]'}`}>
              <div className="px-3">
