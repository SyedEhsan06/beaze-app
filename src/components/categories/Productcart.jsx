      ...
      {data.length >= 1 ? (
        <>
          <div className="pt-5 z-[99999]">
            <div className={`overflow-y-auto transition-all duration-300  border-b ${showprice ? 'lg:max-h-[40vh] max-h-[38vh] ' : showremove ? 'max-h-[50vh] lg:max-h-[55vh]' : 'md:max-h-[60vh] max-h-[56vh]'}`}>
              <div className="px-3">
