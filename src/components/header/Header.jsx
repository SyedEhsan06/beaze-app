...
{
    showhide === 1 && 
                        <div className="absolute w-full left-0 top-[110%] transition-all duration-75 flex justify-center">
                         <div className='py-3 px-7 bg-white rounded border'>
                            <ul className=' text-lg'>
                                <li className='pb-2'><Link href='/'>Shop</Link></li>
