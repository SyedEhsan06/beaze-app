              ...
              <form onSubmit={handleOtpVerify} className="w-full">
                <div className=" w-full">
                  ...
                  <div className=" mt-6 flex gap-3 items-center">
                    ...
                    <div>
                      <button className=" items-center flex gap-3 px-5 py-1 bg-[#DED5D5] context  rounded-[9px]  lg:text-sm text-xs font-[500] text-[#717070]  shadow-input ">
                        <FaRegClock /> 12s | Resend{" "}
                      </button>
                    </div>
                  </div>
                </div>
