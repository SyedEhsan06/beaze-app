          ...
          <div className="w-full">
            <div className="w-full flex gap-16">
              ...
              <div className="w-[50%] ">
               ...
               <p  className=' text-[400] context text-sm mb-3 '>Women’s Clothing / Tops & Blouses / Classic Shirts </p>
...
<div className='mt-5'>
    <button className='context font-[500] text-2xl w-[80%] flex items-center gap-x-5' onClick={() => setshowdesc(!showdesc)}>Description & Details <BiSolidChevronDown className={` transition-all duration-150 ${showdesc ? ' rotate-180' : 'null'}`}/></button>
</div>
             
               </div>


               <div className={`w-full   context mt-6 ${showdesc ? 'block' : 'hidden'}`}>
            ...
            <p className='  text-[1rem] font-[500] text-text-secondary leading-[1rem] text-center'>Loose Fit Material</p>
                </div>
                <div className='w-full flex flex-col  items-center justify-center'>
                <div className='w-[29px] h-[34px] relative mb-3 rounded-[8px] '>
                <Image
            ...
            <p className='  text-[1rem] font-[500] text-text-secondary leading-[1rem] text-center'>Natural Dyes used</p>
                </div>
                <div className='w-full flex flex-col  items-center justify-center'>
                <div className='w-[29px] h-[34px] relative mb-3 rounded-[8px] '>
                <Image
            ...
            <p className=' text-[1rem] font-[500] text-text-secondary leading-[1rem] '>Water Resistant Material</p>
                </div>
                <div></div>
                <div></div>
                </div>
              ...
              <div className='w-full text-xl leading-[18px]'>
                ...
                <p className='font-[400]'>The body fabric is made of 100% recycled nylon plain weave for durability, with a DWR (durable water repellent) finish that sheds light moisture</p>
                </div>
              <div className='w-full text-xl leading-[18px]'>
                <h5 className='font-[600]'>
Elasticized Waist and Regular Rise</h5>
                <p className='font-[400]'>These shorts have a regular rise and an elastic waistband with a drawcord for a customizable fit</p>
                </div>
              ...
              <div className='w-full text-xl leading-[18px]'>
                ...
                <p className='font-[400]'>The pockets are lined with recycled polyester mesh for drainage</p>
                </div>


              <div className='w-full text-xl leading-[18px]'>
                <h5 className='font-[600]'>Key Loop</h5>
                <p className='font-[400]'>There's an elastic key loop inside the right pocket</p>
                </div>

              <div className='w-full text-xl leading-[18px]'>
                <h5 className='font-[600]'>Inseam Length</h5>
                <p className='font-[400]'>These shirts have a 5" inseam</p>
                </div>
