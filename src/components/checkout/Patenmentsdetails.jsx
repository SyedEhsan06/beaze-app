  ...
  return (
    <div className=" w-full">
      <div className=" flex gap-x-10  headtext font-[600] text-2xl items-center px-4 mt-4 ">
        <div>
          <button className=" font-[800] text-3xl text-[#039C2EB0] text-opacity-[69%] flex items-center">
        ...
        <div>
          <button className="text-[#998F8F]">Payment</button>
        </div>
      </div>
      ...
      <div className=" grid grid-cols-1 gap-y-5 mt-4">
        <div className="w-full">
          ...
          >
            <h6 className="headtext font-extrabold text-[1.5rem] text-text-secondary ">
              Welcome Sherlock
            </h6>
            <button
              className="ml-auto underline context  text-text-secondary  font-[400] text-lg"
              onClick={() => settabs(0)}
            >
              Edit
            </button>
          ...
          >
            <div>
              <h6 className=" headtext text-text-secondary font-[700] text-[1rem]">
            ...
            <div className="mt-5">
              ...
              <div className=" w-full my-6 context">
                <div className=" flex items-center">
                  ...
                  <div className="w-[95%]">
                    <label
                      htmlFor="accout"
                      className=" font-[400] text-[1rem] cursor-pointer"
                    >
              ...
              <div className="w-full flex justify-center">
                <button
                  className="headtext font-[800]  text-[1.4rem] py-3 w-[40%] rounded bg-theme-footer-bg text-white"
          ...
          >
            <div className=" flex ">
              ...
              <div className=" flex items-center ms-auto">
                ...
                <div className="">
                  <label
                    htmlFor="svedaccount"
                    className=" font-[400] text-[1rem] cursor-pointer text-text-secondary context"
                  >
                    Use Saved Address
                  </label>
                </div>
            ...
            <form>
              <div className=" mt-5 grid grid-cols-1 gap-y-2">
                <div className=" w-full context">
                  ...
                  <input
                    type="text"
                    id="add1"
                    className="w-full border border-text-secondary shadow-sm px-4 py-3 rounded-lg   focus:outline-none transition-all duration-100   relative leading-normal checkout-input placeholder:text-[#AAA5A5] placeholder:font-[400]"
              ...
              <div className="w-full flex justify-center mt-6">
                <button className="headtext font-[800]  text-[1.4rem] py-3 w-[50%] rounded bg-theme-footer-bg text-white">
            ...
            <div className="mt-4 context ">
              <div className="p-4  border  rounded-lg">
                <div className="w-full flex">
                  ...
                  <span className="ml-auto text-lg text-[#039C2E] font-[500]">
                    Free
                  </span>
                </div>
                ...
                <div className="w-full flex mt-2">
                  ...
                  <span className="ml-auto text-lg font-[500]">
