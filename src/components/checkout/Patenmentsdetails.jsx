        ...
        <div className="lg:w-[60%] w-[100%]">
          <div className=" w-full">
            <div className=" flex lg:gap-x-10 gap-x-3  headtext font-[600]  items-center md:px-4 mt-4 ">
              ...
              <div>
                <button
                  className={`lg:text-2xl flex items-center ${
                    checkoutgreen
                      ? " text-[#039C2EB0] font-[800] lg:text-3xl text-lg"
                      : "text-black"
                  }`}
                >
              ...
              <div>
                <button
                  className={` lg:text-2xl text-[1rem] ${
                    checkoutgreen ? " text-black" : " text-[#998F8F]"
                  }`}
                >
                  Payment
                </button>
              ...
              <div className="w-full">
                ...
                >
                  <div className=" flex flex-col lg:flex-row ">
                    ...
                    <div
                      className={`items-center ms-auto text-sm lg:text-[1rem] ${
                        profilelogindata.first_name ? "flex" : "hidden"
                      }`}
                    >
                ...
                {isAccountCreated || isAccountCreatedbilling ? (
                        ...
                        {savedaddress.length >= 1 ? (
                          ...
                          <div className="w-full">
                            <h4 className=" font-semibold text-center text-lg ">
                              Oops Looks like there is not any saved addrerss
                              available{" "}
                            </h4>
                          </div>
                        )}
                  ...
                  <div className="optsection">
                    ...
                    <div className=" grid grid-cols-2 gap-x-4 headtext py-2 mt-6">
                      <button
                        className=" w-full  text-[#474747] font-[300]lg:text-xl md:text-lg text-[1rem] py-2 rounded border-[0.3px] border-[#000000] "
